...
import { RiCheckLine, RiUserLine, RiCloudLine, RiSubtractLine, RiArrowRightSLine } from "@remixicon/react";
...
const plans: Plan[] = [
    {
        name: 'Starter',
        price: '$0',
        description: 'For individuals and small teams that need to replace a VPN for remote access.',
        capacity: ['Up to 5 users, 1 admin', 'Up to 10 workspaces'],
        features: ['Up to 1000/req. per day', '5 GB max storage', 'Community Slack Support'],
        isStarter: true,
        isRecommended: false,
    ...
    },
    {
        ...
        description: 'For small teams that need to replace a VPN for remote access.',
        capacity: ['Up to 100 users, 3 admins', 'Up to 20 workspaces'],
        features: ['Unlimited requests', '$0.07 per processed GB', '$0.34 per stored GB', 'Slack Connect'],
        isStarter: false,
        isRecommended: false,
    ...
    return (
        <div>
            ...
            <main className="mt-40 max-w-6xl mx-auto px-3">
                        ...
                        >
                                ...
                                <div className="h-4 flex items-center">
                                    <div className="relative w-full">
                                        ...
                                        <div className="relative flex justify-center">
                                            <span className="bg-white px-3 text-xs font-medium text-indigo-600">Most popular</span>
                                        </div>
                                    </div>
                                </div>
                            ) :
                            ...
                            <div className="mt-3 flex gap-x-3 items-center">
                                <span className="text-5xl font-semibold text-gray-900">
                                    {!plan.isStarter ? (plan.price as any)[frequency.value] : plan.price}
                                </span>
                                {!plan.isStarter ? (
                                    <div>
                            ...
                            <div className="flex flex-col justify-between">
                                ...
                                <div>
                                    {plan.isStarter ? (
                                        ...
                                        >
                                            {plan.buttonText}
                                            <RiArrowRightSLine className="size-5 shrink-0" aria-hidden="true" />
                                        </a>
                                    ) : (
                                        <a
                                            href={plan.buttonLink}
                ...
                <div className="mt-20 sm:mt-36 mx-auto max-w-xl lg:max-w-6xl space-y-4">
                    ...
                    <figure className="mx-auto max-w-4xl">
                        ...
                        <figcaption className="mt-10 flex items-center justify-center gap-x-4">
                            ...
                            />
                            <div>
                                <div className="text-sm font-semibold text-gray-900">Peter Coil</div>
                    ...
                    {tiers.map((tier) => (
                        ...
                        >
                            <div className={cx(
                                ...
                                <h3 id={tier.id} className="text-base font-semibold leading-6 text-gray-900">
                                    {tier.title}
                                </h3>
                ...
                {/* plan details (lg+) */}
                <div className="isolate mt-20 sm:mt-36 hidden lg:block">
                        ...
                        <table className="w-full table-fixed border-separate border-spacing-x-8 text-left">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    {tiers.map((tier) => (
                                        <th key={tier.id} scope="col" className="px-6 xl:px-8">
                                            <div className="text-sm font-semibold leading-7 text-gray-900">{tier.title}</div>
                                            <div className="text-sm font-normal text-gray-600">{tier.price}</div>
                                        </th>
                                    ))}
                                </tr>
                            </thead>
                                                        ...
                                                        {typeof feature.tiers[tier.title] === 'string' ? (
                                                            ...
                                                            <>
                                                                ...
                                                                <span className="sr-only">
                                                                    {feature.tiers[tier.title] === true ? 'Included' : 'Not included'} in {tier.title}
                                                                </span>
                                                            </>
                                                        )}
                                                    </td>
                ...
                <div className="mt-20 sm:mt-36 grid grid-cols-1 lg:grid-cols-12 lg:gap-14">
                    ...
                    <div className="mt-6 lg:mt-0 col-span-full lg:col-span-7 ">
                        <Accordion type="multiple" className="mx-auto">
                            {faqs.map((item) => (
                                <AccordionItem value={item.question} key={item.question} className="first:pb-3 first:pt-0 py-3">
