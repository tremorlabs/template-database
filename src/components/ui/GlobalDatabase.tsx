...
export const GlobalDatabase: FunctionComponent = () => {
  ...
  return (
    ...
    <section className="relative shadow-xl shadow-black/30 flex flex-col mt-28 md:mt-40 justify-center items-center bg-gray-950 overflow-hidden pt-24 rounded-3xl max-w-6xl w-full mx-auto">
      ...
      <h2 className="mt-6 tracking-tighter text-5xl md:text-8xl font-bold text-transparent bg-clip-text inline-block from-white to-indigo-100 bg-gradient-to-b px-2 z-10 text-center">
