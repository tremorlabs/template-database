...
export function Navigation() {
  ...
  return (
    <header
      className={cx(
        "fixed top-4 inset-x-0 rounded-xl mx-auto max-w-6xl flex justify-center z-10 transition-all duration-500 h-14 border border-transparent ease-[cubic-bezier(0.16,1,0.3,1.03)] animate-slide-down-fade",
        scrolled
          ? "border-gray-100 bg-white/80 shadow-2xl shadow-black/10 max-w-3xl backdrop-blur-nav"
          : "bg-white/0"
      )}
