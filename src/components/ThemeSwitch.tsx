    ...
    >
      <div
        className={cx(
          ...
          "bg-transparent",
          // checked
          "group-data-[state=checked]:bg-indigo-50 dark:group-data-[state=checked]:bg-indigo-500/20 group-data-[state=checked]:text-indigo-600 dark:group-data-[state=checked]:text-indigo-300",
          // focus
          focusRing
        )}
      >
